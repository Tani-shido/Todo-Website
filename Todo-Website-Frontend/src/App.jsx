  ...
  <div className='h-full w-full'>
    <div className='w-full md:w-7xl md:mt-32 p-4 mx-auto bg-blue-100 rounded-xl '>
      <div className='flex justify-between'>
        <div className='p-8 w-[16%] text-center text-2xl bg-blue-400 border-none rounded-xl hover:bg-blue-300 hover:font-semibold shadow-md transition-all duration-150'>Add Page</div>
        <div className='p-8 w-[60%] bg-blue-300 text-2xl text-center font-semibold border-none rounded-xl shadow-md transition-all duration-150'>
          A Page To~do
        </div>
        <div className='p-8 w-[16%] text-center text-2xl bg-blue-400 border-none rounded-xl hover:bg-blue-300 hover:font-semibold shadow-md transition-all duration-150'>Add Todo</div>
      </div>
